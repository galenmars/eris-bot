...
class SetupCog(commands.Cog, name="Setup"):
    ...
    async def setup(self, interaction: discord.Interaction) -> None:
        ...
        await _update(
            ...
            f"2. https://galenmars.github.io/eris-bot/eris-fleet-builder.html — fleet builder URL\n"
            f"2. https://galenmars.github.io/eris-bot/eris-army-builder.html — army builder URL\n"
...
async def _post_requirements_doc(
    ...
    doc = (
        ...
        f"  1. Assign **ERIS Admin** role to your moderation team\n"
        f"  2. https://galenmars.github.io/eris-bot/eris-fleet-builder.html — fleet builder URL\n"
        f"  3. https://galenmars.github.io/eris-bot/eris-army-builder.html — army builder URL\n"
